          ...
          <LegalSection number={4} title="How we collect information">
            ...
            <LegalList
              items={[
                ...
                "request an Opportunity Review or Package Validation",
          ...
          <LegalSection number={5} title="Why we collect information">
            ...
            <LegalList
              items={[
                ...
                "assess and negotiate with factories and suppliers in China and other overseas markets",
                ...
                "issue invoices for, and process payment of, our own fees",
                "track the payment status of milestones you pay directly to factories, suppliers or freight providers, where relevant to coordinating your project",
                "maintain records",
